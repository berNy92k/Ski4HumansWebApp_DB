...
<div class="container">
    <div style="padding-bottom: 20px">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Strefa klienta</a>
            </li>
        </ul>
    </div>
    <div>
        ...
        <div class="firstMessage" style="padding-left: 20px;padding-right: 20px;text-align: justify">
            <ul style="font-size: 14px">
                ...
                <li>
                    <a href="polityka-prywatnosci.jsp">Polityka prywatności</a>
                </li>
                <li>
                    <a href="dostawa-i-platnosci.jsp">Dostawa i płatności</a>
                </li>
                <li>
                    <a href="reklamacje-i-zwroty.jsp">Reklamacje i zwroty</a>
                </li>
                <li>
                    <a href="faq.jsp">FAQ</a>
                </li>
                <li>
                    <a href="odbior-osobisty.jsp">Odbiór osobisty</a>
                </li>
                <li>
                    <a href="zagraniczna-wysylka.jsp">Zagraniczna wysyłka</a>
                </li>
                <li>
