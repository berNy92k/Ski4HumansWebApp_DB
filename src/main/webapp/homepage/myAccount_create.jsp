...
<div class="container">
    ...
    <div class="width500pxMargin0auto">
        ...
        <div>
            <form action="../homepage/updateCustomer" method="post" id="createCustomerForm"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" name="email" aria-describedby="email"
                           placeholder="Wpisz email" value="${sessionScope.customerLogged.email}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="firstName" name="firstName"
                           ...
                           placeholder="Wpisz imię" value="${sessionScope.customerLogged.firstName}">
                </div>
                <div class="form-group">
                    <label for="lastName">Nazwisko</label>
                    <input type="text" class="form-control" id="lastName" name="lastName"
                           aria-describedby="lastName"
                           placeholder="Wpisz nazwisko" value="${sessionScope.customerLogged.lastName}">
                </div>
                <div class="form-group">
                    <label for="street">Ulica</label>
                    <input type="text" class="form-control" id="street" name="street" aria-describedby="street"
                           placeholder="Wpisz nazwę ulicy" value="${sessionScope.customerLogged.street}">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="homeNumber" name="homeNumber"
                           ...
                           placeholder="Wpisz numer domu" value="${sessionScope.customerLogged.homeNumber}">
                </div>
                <div class="form-group">
                    <label for="city">Miasto</label>
                    <input type="text" class="form-control" id="city" name="city" aria-describedby="city"
                           placeholder="Wpisz miasto" value="${sessionScope.customerLogged.city}">
                </div>
                <div class="form-group">
                    <label for="zipCode">Kod pocztowy</label>
                    <input type="text" class="form-control" id="zipCode" name="zipCode" aria-describedby="zipCode"
                           placeholder="Wpisz kod pocztowy" value="${sessionScope.customerLogged.zipCode}">
                </div>
                <div class="form-group">
                    <label for="country">Kraj</label>
                    <input type="text" class="form-control" id="country" name="country" aria-describedby="country"
                           placeholder="Wpisz kraj" value="${sessionScope.customerLogged.country}">
                </div>
                <div class="form-group">
                    <label for="phone">Numer telefonu</label>
                    <input type="text" class="form-control" id="phone" name="phone" aria-describedby="phone"
                           placeholder="Wpisz numer telefonu" value="${sessionScope.customerLogged.phone}">
                </div>
